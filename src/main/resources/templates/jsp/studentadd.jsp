...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB1RO9FRb1bVKIVwePR2_hkCl-UdccVSfE&libraries=places&callback=initAutocomplete"
         async defer></script>
...
<div id="wrapper" >
            ...
            <tr>
                     ...
                     <tr>
                          ...
                          <td><input type="date" name="DOB" required="true" class="form-control col-sm-4"> </td>
                           ...
                           <td><input type="radio" name="Gender" value="Male" style="width:25px;" >Male <input type="radio" name="s_gender" value="Female" style="width:25px;" >Female</td>
                                  ...
                                  <tr>
                          <th> Area :</th>
                          <td><input type="text" name="Area" id="a" placeholder="Area" required="true" class="form-control col-sm-4"></td>
                           <th>City:</th>
             ...
             <tr>
                          ...
                          <td><input type="text" name="pinCode" placeholder="Pin Code" required="true" class="form-control col-sm-4"></td>
                           <th>Father Name :</th>
                           <td><input type="text" name="fathername" placeholder="Father Name" class="form-control col-sm-4"> </td>
                      </tr>
 ...
 <tr>
                          ...
                          <input type="number" name="Contact" pattern="^\d{10}$" placeholder=" Mobile N" required="true" class="form-control col-sm-4"</td>
                           <th>Email :</th>
                           <td>  <input type="Email"  placeholder="Email" required="true" name="emailid" required="true" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" class="form-control col-sm-4"> </td>
                      </tr>
                      </table>
   ...
   <div class="col-md-12">
		<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div   style="margin-left:12" class="table-responsive" data-pattern="priority-columns" data-focus-btn-icon="fa-asterisk" data-sticky-table-header="true" data-add-display-all-btn="true" data-add-focus-btn="true">
...
<td>rs.getString("stop_name")</td>
<td>rs.getString("lat")</td>
<td>rs.getString("longti"</td>
<td>
    <div class="btn-group">
        <a href='mapEdit.jsp?stop_id==rs.getString("stop_id")%>'><button type="button" class="btn btn-default btn"><i class="glyphicon glyphicon-pencil"></i></button></a>
         <a href='mapEdit.jsp?deleteMap=rs.getString("stop_id")%>'><button type="button" class="btn btn-default btn" onclick="return confirm('Are you sure you want to Delete?')"><i class="glyphicon glyphicon-trash"></i></button></a>
  </div>   
</td>
</tr>
	</c:forEach>
